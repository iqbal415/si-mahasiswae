            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th width="17%">Nim</th><th>Nama</th><th>Alamat</th><th>Jurusan</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="report/datamahasiswa_satu.php?nim=<?= $data['nim'] ?>" target="_blank" class="btn btn-info btn-xs">
