        ...
        <div class="col-xs-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title">Update Matakuliah</h3>
                </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-9">
                                <button type="submit" class="btn btn-success">
                                    <span class="fa fa-edit"></span> Update Mata Kuliah</button>
                            </div>
                        </div>
                    </form>
...
if($_POST){
    ...
    //buat sql
    $sql="UPDATE tbl_matakuliah SET nim = '$Nim', nama='$Nama', nama_matkul ='$nama_matkul', nama_dosen ='$nama_dosen', jlh_sks ='$jlh_sks' WHERE nim='$Nim'"; 
